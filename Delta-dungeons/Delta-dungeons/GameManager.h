...
public:
	...
	static void staticCheckCollisionCallbackFunction(void* p, std::shared_ptr<BehaviourObject> collider, int x, int y, int w);
	void passCollisionCheck(std::shared_ptr<BehaviourObject> collider, int x, int y, int w);
