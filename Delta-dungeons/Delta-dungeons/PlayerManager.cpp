...
/// </summary>
void PlayerManager::createPlayer(cbCollision collisionCb, cbNextLevel nextLevelcb, cbCamera cb, cbInteract interactCB, cbGameOver gameOverCB, cbHUD hudCB, void* p)
{
	player = std::make_shared<Player>(collisionCb, nextLevelcb, cb, interactCB, gameOverCB,hudCB, p);
}
