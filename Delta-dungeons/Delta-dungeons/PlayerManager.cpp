...
/// </summary>
void PlayerManager::createPlayer(cbCamera cb, cbCheckCollision tileCB, cbEquipmentManager cbEquipment, cbNPCManager npcMF, void* p)
{
	player = std::make_shared<Player>(cb, tileCB, cbEquipment, npcMF, p);
