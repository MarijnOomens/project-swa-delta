...
/// </summary>
void PlayerManager::createPlayer(const std::string& levelName, cbCollision collisionCb, cbThrowCollision throwCB, cbCamera cb, cbInteract interactCB, cbGameOver gameOverCB, cbHUD hudCB, void* p)
{
