...
public:
	...
	static void staticInteractCallbackFunction(void* p, std::shared_ptr<BehaviourObject> player, int x, int y, int w);
	void interactCallbackFunction(std::shared_ptr<BehaviourObject> player, int x, int y, int w);
