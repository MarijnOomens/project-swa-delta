...
public:
	...
	std::shared_ptr<Pokemon> getPokemon(int x, int y, const std::string& name, cbCollision collisionCb, cbCameraRange cameraCb, cbAiCollision aiCollision, void* p, int attackTime);
